...
export default class ImportTableCsvDialog extends DialogView {
	...
	constructor(serializedState) {
		...
		this.uri = this.viewManager.addTextInput(importTableCsvForm, 'uri', language.uri);
		this.tableDrop = viewManager.addDropDownMenu(importTableCsvForm, 'tables', null, []);
		const uri	= this.uri;
		...
		importTableCsvForm.addEventListener('submit', function(event) {
			editor.importTableFromCsv(new File([""], uri.value);
