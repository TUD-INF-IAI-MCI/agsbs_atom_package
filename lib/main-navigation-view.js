...
export default class MainNavigationView {
	...
	constructor(serializedState) {
		...
		viewManager.groupButtons(language.documentTitle, [saveChangesButton, undoButton, redoButton, htmlPreviewButton, generateFileButton, convertEntireProjectButton, labelDropDown, dropDownMenuConversionProfile]);
	...
	convertToHtml() {
		...
		profile = cb.options[cb.selectedIndex].value
		var promise = matuc.checkIfFileIsWithinLecture();
		promise.then(function (isWithinLecture) {
			if (isWithinLecture) {
				matuc.checkAndSaveChanges()
