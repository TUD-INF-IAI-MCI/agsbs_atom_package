...
export default class MainNavigationView {
	...
	constructor(serializedState) {
		...
		// create buttons
		viewManager.addButton(this.element, 'new_project', language.newProject, 'new_project', viewManager.toggleDialog, newProjectDialog, 'f2');
		viewManager.addButton(this.element, 'edit_project', language.editProject, 'fa-pencil', viewManager.toggleDialog, editProjectDialog);
