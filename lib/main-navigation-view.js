...
export default class MainNavigationView {
	...
	constructor(serializedState) {
		...
		const generateFileButton = viewManager.addButton(tools, 'generate_file', language.generateFile, 'fa-file-code-o', this.convertToHtml);
		const convertEntireProjectButton = viewManager.addButton(tools, 'convert_project', language.convertEntireProject, 'check_all', this.convertEntireProject, undefined, 'f6');
