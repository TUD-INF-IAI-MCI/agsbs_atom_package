...
export default class AgsbsAtomPackageView {
	...
	constructor(serializedState) {
		...
		const testEditorFunctionButton = document.createElement('button');
		const testEditorFunctionLabel = document.createTextNode('Test Editor Function');
		testEditorFunctionButton.appendChild(testEditorFunctionLabel);
		testEditorFunctionButton.onclick = function() {
			atom.commands.dispatch(testEditorFunctionButton, 'agsbs-atom-package:testEditorFunction');
		};
		this.element.appendChild(testEditorFunctionButton);
	}
