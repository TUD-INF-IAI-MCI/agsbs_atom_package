...
export default class MainNavigationView {
	...
	constructor(serializedState) {
		...
		const highlightButton = viewManager.addButton(tools, 'highlight', language.highlight, 'fa-highlight',  this.highLight);
		...
		viewManager.groupButtons(language.documentTitle, [saveChangesButton, undoButton, redoButton, htmlPreviewButton, highlightButton, generateFileButton, convertEntireProjectButton]);
