...
export default class MainNavigationView {
	...
	constructor(serializedState) {
		...
		const savePChangesButton = viewManager.addButton(tools, 'save_changes', language.saveChanges, 'fa-floppy-o', editor.save);
		...
		const cloneButton = viewManager.addButton(tools, 'clone', 'clone', '', git.clone);
