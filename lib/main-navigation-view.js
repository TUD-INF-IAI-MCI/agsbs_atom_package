...
export default class AgsbsAtomPackageView {
	...
	constructor(serializedState) {
		...
		testMainDialogButton.onclick = function() {
			atom.commands.dispatch(testMainDialogButton, 'agsbs-atom-package:toggleDialog');
		};
		...
		testNewProjectDialogButton.onclick = function() {
			atom.commands.dispatch(testNewProjectDialogButton, 'agsbs-atom-package:toggleNewProject');
		};
