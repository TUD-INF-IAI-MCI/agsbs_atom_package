...
export default class MainNavigationView {
	...
	constructor(serializedState) {
		...
		const dropDownMenuConversionProfile = viewManager.addDropDownMenu(tools, "combobox_converion_profile", language.conversionProfile, []);
		viewManager.groupButtons(language.documentTitle, [saveChangesButton, undoButton, redoButton, htmlPreviewButton, generateFileButton, convertEntireProjectButton, dropDownMenuConversionProfile]);
