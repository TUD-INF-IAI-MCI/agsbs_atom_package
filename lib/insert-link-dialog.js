...
export default class InsertLinkDialog extends DialogView {
	...
	constructor(serializedState) {
		...
		var linkText = this.viewManager.addTextInput(insertLinkForm, 'link-text', language.linkText);
	...
	setSelectedAsLinkText() {
		console.log('SPAST');
		linkText.value = linkText.value = atom.workspace.getActivePaneItem().getSelectedText();
	}
}
