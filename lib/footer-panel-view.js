...
export default class FooterPanelView {
	...
	constructor(serializedState) {
		...
		var insertLinkDialog = agsbs.renderInsertLinkDialog();
		...
		viewManager.addButton(this.element, 'horizontal-rule', language.horizontalRule, 'fa-minus', editor.addHorizontalRule, undefined, 'alt + shift + r');
		...
		const linkButton = viewManager.addButton(this.element, 'link', language.insertLink, 'fa-link', viewManager.toggleDialog, insertLinkDialog);

		linkButton.addEventListener('click', function() {
			console.log(insertLinkDialog.getItem());
			insertLinkDialog.setSelectedAsLinkText();
		});
	}
