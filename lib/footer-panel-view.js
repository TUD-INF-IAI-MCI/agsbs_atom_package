...
export default class FooterPanelView {
	...
	constructor(serializedState) {
		...
		const linkButton = viewManager.addButton(this.element, 'link', language.insertLink, 'fa-link', viewManager.toggleDialog, insertLinkDialog.panel);
		viewManager.addButton(this.element, 'table', language.insertTable, 'fa-table', viewManager.toggleDialog, insertTableDialog);
		viewManager.addButton(this.element, 'graphic', language.insertGraphic, 'fa-picture-o', viewManager.toggleDialog, insertGraphicDialog);
		viewManager.addButton(this.element, 'footnote', language.insertFootnote, 'footnote', viewManager.toggleDialog, insertFootnoteDialog);
