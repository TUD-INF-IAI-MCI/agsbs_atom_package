...
export default class FooterPanelView {
	...
	constructor(serializedState) {
		...
		const formulaInlineButton = viewManager.addButton(this.element, 'formula-inline', language.formulaInline, 'fa-superscript', editor.insertFormulaInline, undefined, '');
