...
export default class FooterPanelView {
	...
	constructor(serializedState) {
		...
		viewManager.addButton(this.element, 'headline1', language.headline1, 'fa-header', editor.headline, 1, 'alt + shift + 1');
		viewManager.addButton(this.element, 'headline2', language.headline2, 'fa-header', editor.headline, 2, 'alt + shift + 2');
		viewManager.addButton(this.element, 'headline3', language.headline3, 'fa-header', editor.headline, 3, 'alt + shift + 3');
		viewManager.addButton(this.element, 'headline4', language.headline4, 'fa-header', editor.headline, 4, 'alt + shift + 4');
		viewManager.addButton(this.element, 'headline5', language.headline5, 'fa-header', editor.headline, 5, 'alt + shift + 5');
		viewManager.addButton(this.element, 'headline6', language.headline6, 'fa-header', editor.headline, 6, 'alt + shift + 6');
