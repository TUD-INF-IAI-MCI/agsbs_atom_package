...
export default class FooterPanelView {
	...
	constructor(serializedState) {
		...
		viewManager.addButton(this.element, 'formula', language.formula, 'fa-fax', editor.insertFormula, undefined, 'alt + shift + f');
		viewManager.addButton(this.element, 'blockquote', language.blockquote, 'fa-indent', editor.blockquote, undefined, 'alt + shift + b');
