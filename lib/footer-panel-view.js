...
export default class FooterPanelView {
	...
	constructor(serializedState) {
		...
		const insertTableCsvDialog = agsbs.renderInsertTableCsvDialog();
		...
		viewManager.addButton(this.element, 'table-csv', language.insertTableCsv, 'fa-random', viewManager.toggleDialog, insertTableCsvDialog);
