...
export default class FooterPanelView {
	...
	constructor(serializedState) {
		...
		viewManager.addButton(this.element, 'strikethrough', language.italic, 'fa-strikethrough', editor.strikethrough, undefined, 'alt + shift + t');
		...
		viewManager.addButton(this.element, 'blockquote', language.blockquote, 'fa-quote-right', editor.blockquote, undefined, 'alt + shift + b');
