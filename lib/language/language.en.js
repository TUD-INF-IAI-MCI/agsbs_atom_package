...
export default class Language {
	...
	constructor() {
		...
		this.checkFile = 'Check file ';
		this.begin = "Begin";
		this.end = "End";
		this.errorMessage = 'Error message is:';
		this.addContentHere = "Add AND FORMAT CONTENT HERE";
		//temporary warnings
		...
		this.conversionProfile = 'conversion profile';
		this.blind = 'blind';
		this.visuallyImpaired = 'visually impaired';
		...
		//insert textboxes
		this.insertTextbox = "Add annotation/text box ";
		this.insertTextboxContent = "Content of annotation, textbox/textframe";
		this.insertTextboxTitle = "title of the textbox/textframe if existing";
		this.textboxContentPlaceholder = "Only required for annotation of the transcriber";
		this.textFrameCheckbox = "text frame";
		this.textBoxCheckbox ="text box";
		this.textBox = "text frame";
		this.textFrame = "text box";
		this.annotation = "Annotation of the transcriber"
		this.color = "Color";
		this.colorRed = "Red";
		this.colorBlue = "Blue";
		...
		this.colorViolet = "Violett";
		this.allColors = "colorBlack, colorRed, colorGreen, colorYellow, colorOrange, colorBlue, colorBrown, colorGrey, colorViolet";
		//footer-panel
		...
		this.submit = 'Submit';
		//git
		this.gitUser = 'Username  (ZIH-Login)';
		this.gitPassword = 'Password';
		this.gitCloneSucess = "Repo was cloned successfully!"
		this.gitCloneError = "An error occurs during the cloning. Check whether you load your private key."
		//new-project
		...
		this.importTableError = "Error during table import";
		this.importTableErrorText = "Check the csv table";
		...
		this.thereAreNoCsvFileInFolder = "No csv-file found in folder or the file names contain spaces."
		this.addPictureToFolder = "Save pictures in folder ";
		this.addCsvFileToFolder = "Save csvlfile in folder ";
		this.ErrorNoPicture = "Not pictures found!"
		this.ErrorNoCsvFile = "Not csv files found!"
		this.or = 'or';
