...
export default class Language {
	...
	constructor() {
		...
		this.wrongMatucVersion = "Installieren Sie die aktuelles Matuc Version. Die aktuelles Version ist ${version}.";this.checkFile = 'Überprüfen Sie die Datei ';
		this.begin = "Begin";
		this.end = "End";
		this.checkFile = 'Check this file ';
		...
		this.insertTextboxContent = "Content of annotation";
