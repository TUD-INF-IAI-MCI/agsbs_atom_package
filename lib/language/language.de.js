...
export default class Language {
	...
	constructor() {
		...
		//git
		this.repoName = "Name des Git-Repos";
		this.clone = "Klonen";
		this.gitCloneSucess = "Repo wurde erfolgreich geklont!"
		//main-navigation
		this.projectTitle = 'Projekt';
		this.cloneExistingRepo = "Klonen eines existierenden Repos";
		...
		this.newFile = 'neue Datei anlegen';
		...
		this.conversionProfile = 'Konvertierungprofil';
		this.blind = 'blind';
		this.visuallyImpaired = 'sehbehindert';
...
<<<<<<< HEAD
		this.insertTextboxContent = "Inhalt der Anmerkung/Textbox/Textrahmen";
		this.insertTextboxTitle = "Titel der Textbox/Textrahmen falls vorhanden";
=======
		this.insertTextboxContent = "Inhalt der Anmerkung oder Titel der Textbox/Textrahmen";
		this.insertTextboxTitle = "Titel der Textbox/Textrahmen falls vorhandenen";
>>>>>>> ec30a71a20a8fc2110148c24ff333ac807c3b1f4
		...
		this.gitUser = 'Benutzername (ZIH-Login)';
		this.gitPassword = 'Passwort';
		this.gitCloneError = "Während des Klonen ist ein Fehler aufgetreten. Überprüfen Sie, ob sie ihren privaten Schlüssel geladen haben."
		...
		this.thereAreNoCsvFileInFolder = "Es sind keine Tabellen im Ordner gespeichert oder die Dateinamen enthalten Leerzeichen.";
		this.addPictureToFolder = "Speichern Sie Bilder im Ordner ";
		this.addCsvFileToFolder = "Speichern Sie csv-Dateien im Ordner ";
		this.ErrorNoPicture = "Keine Bilder gefunden!"
		this.ErrorNoCsvFile = "Keine CSV-Dateien gefunden!"
		this.or = 'oder';
