...
export default class EditProjectDialog extends DialogView {
	...
	constructor(serializedState) {
		...
		promise.then(function(data) {
			...
			outputFormatDropdown = viewManager.addDropDownMenu(editProjectForm, 'output_format', data.format, ['html', 'was', 'sonst?']);
		...
		function save() {
			...
			var promiseUpdate = matuc.updateMetaData(alternatePrefix, outputFormat, sourceAuthor, institution,
