...
import InsertTableCsvDialog from './insert-table-csv-dialog';
...
export default {
	...
	renderInsertTableCsvDialog() {
		this.insertTableCsvDialog = atom.workspace.addModalPanel({
			item: new InsertTableCsvDialog().getElement(),
			visible: false
		});
		return this.insertTableCsvDialog;
	},
