...
export default class ViewManager {
	...
	*/
	addNumberPicker (parent, id, label) {
		...
		numberWrapper.classList.add('input_wrapper');
		//Create input.
		...
		//Add all to the parent form.
		numberWrapper.appendChild(numberPickerLabel);
		numberWrapper.appendChild(numberPicker);
	...
	*/
	addDropDownMenu (parent, id, label, options) {
		...
		dropDownWrapper.classList.add('input_wrapper');
		//Create select.
		...
		//Add all to the parent form.
		dropDownWrapper.appendChild(DropDownMenuLabel);
