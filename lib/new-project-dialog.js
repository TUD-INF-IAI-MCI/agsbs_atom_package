...
export default class NewProjectDialog extends DialogView {
	...
	constructor(serializedState) {
		...
		const newProjectPath = this.viewManager.addFileInput(newProjectForm, 'directory', this.language.noFolder);
		const newProjectPreface = this.viewManager.addCheckbox(newProjectForm, 'preface', this.language.preface);
		...
		const newProjectAuthor = this.viewManager.addTextInput(newProjectForm, 'author', 'author');
		...
		const newProjectInstitution = this.viewManager.addTextInput(newProjectForm, 'institution', 'institution');
		const newProjectLanguage = this.viewManager.addDropDownMenu(newProjectForm, 'language', 'language', ['en', 'de', 'fr']);
