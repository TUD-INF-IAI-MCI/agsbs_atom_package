...
export default class NewProjectDialog extends DialogView {
	...
	*/
	constructor(serializedState) {
		...
		const newProjectGitPath = this.viewManager.addTextInput(newProjectForm, 'git_path', language.gitPath);
		const newProjectGitUser = this.viewManager.addTextInput(newProjectForm, 'git_user', language.gitUser);
		const newProjectGitPassword = this.viewManager.addTextInput(newProjectForm, 'git_password', language.gitPassword);
