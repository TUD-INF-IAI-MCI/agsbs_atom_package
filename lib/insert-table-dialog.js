...
export default class InsertTableDialog extends DialogView {
	...
	*/
	constructor(serializedState) {
		...
		selectTableType.id = "tableTypeSelect";
		var tableName = "";
		for(var i = 0; i < tableTypes.length; i++){
			...
			headerCheckboxContainer.appendChild(selectTableType);
		}
		...
		*/
		...
		function addTableHead() {
			...
			// 	editColumnsAndRows();
			// };
			tableHead.children().css('font-weight','bold')
			tableHead.children().css('font-size','1.4em')
		...
		function removeTableHead() {
			...
			// 	};
			// };
			$("#row_0").children().css('font-weight','normal')
			$("#row_0").children().css('font-size','1em')
		};
